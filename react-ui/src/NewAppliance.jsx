      ...
      {newApplType ? (
        <div class="alert alert-success" role="alert">
          ...
          <p class="mb-0 flex al-i-base">
            <button className="btn btn-link color-unset pad-rev" onClick={() => {
        ...
        <form className='new-appl-form' onSubmit={sendQueryForNewAppliance}>
          ...
          <div className="mb-3">
            <label for="serialNumber" className={cn('form-label', { 'invalid-feedback': !!errorMessage }, 'disp-i-b')}>
              {!!errorMessage
                ? errorMessage
                : 'Enter serial number'
              }
            ...
            <div id="serialHelp" class="form-text">
              The serial number of the appliance is on it's back or bottom side 
              and in the attached manual. (( Wash machine: 101, 102, 103; oven: 
              201, 202, 203; coffee machine: 301, 302, 303 ))
            </div>
          </div>
